...
function loadTextureFromURL(gl, url) {
  ...
  const imageRequest = typeof self.createImageBitmap === 'function' ? new Promise((resolve, reject) => {
    fetch(url, {
      mode: 'cors'
...
export default class TextureManager {
  ...
  registerLocalTextureSource(name, source) {
  ...
  registerCustomProtocol(protocol, transform) {
