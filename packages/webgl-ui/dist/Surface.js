...
export default class Surface {
  ...
  setCursor(x, y, forceHitDetection) {
    this._cursorX = x;
    this._cursorY = y;
  ...
  setViewport(width, height) {
    // prettier-ignore
    this._renderGroup.setUniform('projectionMatrix', [2 / width, 0, 0, 0, 0, -2 / height, 0, 0, 0, 0, -0.001, 0, -1, 1, 0, 1]);
  }
  /**
