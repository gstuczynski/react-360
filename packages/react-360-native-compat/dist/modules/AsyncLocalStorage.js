  ...
  _prepareDB() {
    return new Promise((resolve, reject) => {
      ...
      request.onupgradeneeded = event => {
        const db = event.target.result; // If the database has not been created yet, create an object store
