...
export function prepareForCommit(containerInfo) {// no-op
}
export function resetAfterCommit() {// no-op
}
...
export const supportsHydration = false; // Mutation
...
export function commitMount(instance, type, newProps) {// no-op
}
