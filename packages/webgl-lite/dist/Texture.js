...
export default class Texture {
  constructor(gl, options = {}) {
    ...
    if ('source' in options) {
      ...
      if (source == null) {
        gl.texImage2D(gl.TEXTURE_2D, 0, gl.RGBA, this._width, this._height, 0, gl.RGBA, gl.UNSIGNED_BYTE, source);
      } else {
  ...
  setSource(source) {
    ...
    if (source instanceof Image) {
      ...
      gl.pixelStorei(gl.UNPACK_FLIP_Y_WEBGL, 0); // $FlowFixMe - ImageBitmap polyfill won't be compatible with texImage2D
