...
export default class FrameBuffer {
  constructor(gl, width, height) {
    this._gl = gl;
    this._width = width;
    this._height = height; // Create the texture that we will render to the framebuffer
    ...
    gl.framebufferTexture2D(gl.FRAMEBUFFER, gl.COLOR_ATTACHMENT0, gl.TEXTURE_2D, this._texture.getGLTexture(), 0); // Clean up binding, so that future rendering goes back to the main canvas buffer
