...
function setStyles(node, styles) {
  ...
  for (const property in styles) {
    let destination = property; // Handle prefixed properties
...
export default class Overlay {
  ...
  setVRButtonHandler(handler) {
    this._vrButtonHandler = handler;
  }

  setVRButtonState(visible, text, onClick) {
    if (visible) {
      this.enableVRButton();
    } else {
    ...
    this.setVRButtonHandler(onClick);
  }

  setCameraRotation(quat) {
