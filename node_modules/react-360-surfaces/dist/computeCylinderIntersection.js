...
export default function computeCylinderIntersection(intersection, origin, direction, width, height, radius, density) {
  ...
  intersection[0] = intX;
  intersection[1] = -(intY + oy) / (radius * TWO_PI / density) + height / 2; // compute distance from ray origin to surface
