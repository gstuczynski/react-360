...
`;
export default function createEnvironmentSphereProgram(gl) {
  const prog = new WebGL.Program(gl);
  return prog.addShader(VERT, gl.VERTEX_SHADER).addShader(FRAG, gl.FRAGMENT_SHADER).compile().setUniformDefaults({
    u_tintlevel: 0
  });
}