...
const PanoMode = {
  ...
  '3DTB': {
    offsets: [[0, 0, 1, 0.5], [0, 0.5, 1, 0.5]]
  },
  '3DBT': {
    offsets: [[0, 0.5, 1, 0.5], [0, 0, 1, 0.5]]
  },
  '3DLR': {
    offsets: [[0, 0, 0.5, 1], [0.5, 0, 0.5, 1]]
  }
};
...
function loadImageFromURL(url) {
  return typeof self.createImageBitmap === 'function' ? new Promise((resolve, reject) => {
    fetch(url, {
      mode: 'cors'
...
export default class Environment {
  ...
  frame() {
    if (this._fadeValue.isActive()) {
      this._cubemapNode.setUniform('u_tintlevel', Math.max(0, Math.min(1, this._fadeValue.getValue())));
