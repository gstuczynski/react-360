...
export default function createGLTFProgram(gl, attributes) {
  ...
  prog.addShader(VERT, gl.VERTEX_SHADER, defines).addShader(FRAG, gl.FRAGMENT_SHADER, defines).compile().setUniformDefaults({
